    ...
    >
      <article id="blog_article_sherbrooke" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          <p>
            Sherbrooke, ville dynamique des Cantons-de-l'Est, se distingue par son patrimoine
            culturel riche, ses murales urbaines spectaculaires et son cadre naturel enchanteur.
            Ville universitaire vibrante, elle offre un mélange unique d'histoire, d'art
            contemporain et d'activités de plein air.
          </p>
          <div className="my-8">
            <Image
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Ville étudiante animée. Nombreux événements culturels. Circuit des murales
