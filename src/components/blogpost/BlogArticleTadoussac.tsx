...
const hotels = [
  {
    ...
    category: 'Historique',
    description: 'Hôtel emblématique avec vue sur le fjord',
    price: 'À partir de 199$/nuit',
    link: 'https://www.booking.com/hotel/ca/tadoussac.html',
    image: 'https://images.unsplash.com/photo-1589352511666-541c12c8e6c7?auto=format&fit=crop&q=80',
  },
  {
    name: 'Auberge La Galouïne',
    category: 'Charme',
    description: 'Auberge chaleureuse au cœur du village',
    price: 'À partir de 159$/nuit',
    link: 'https://www.booking.com/hotel/ca/auberge-la-galouine.html',
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80',
  },
  {
    name: 'Motel Le Beluga',
    category: 'Vue sur Mer',
    description: 'Vue imprenable sur le Saint-Laurent',
    price: 'À partir de 139$/nuit',
    link: 'https://www.booking.com/hotel/ca/motel-le-beluga.html',
