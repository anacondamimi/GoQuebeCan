...
import { HOTEL_IDS_SEPT_ILES } from '@/data/hotels/byArticle/sept-iles';
...
const hotels = pickHotels(HOTEL_IDS_SEPT_ILES);
...
export default function BlogArticleSeptIles() {
  return (
    <DestinationArticleTemplate slug="sept-iles" title="Sept-Îles - Porte d'entrée de la Côte-Nord">
      <article id="blog_article_sept_iles" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          <p>
            Sept-Îles, nommée d'après son archipel de sept îles, est une ville portuaire majeure de
            la Côte-Nord qui combine harmonieusement développement industriel, nature préservée et
            riche culture autochtone. Son port en eau profonde et son archipel protégé en font une
        ...
        <section className="rounded-lg bg-gray-50 p-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a
              href={bookingAwin('https://www.booking.com/city/ca/sept-iles.html')}
