    ...
    >
      <article id="blog_article_kamouraska" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          <p>
            Kamouraska, pittoresque village du Bas-Saint-Laurent, est réputé pour avoir les plus
            beaux couchers de soleil au Québec. Avec son riche patrimoine architectural, sa
            gastronomie locale et ses paysages à couper le souffle, il offre une expérience
            authentique du Québec maritime.
          </p>
          <div className="my-8">
            <Image
