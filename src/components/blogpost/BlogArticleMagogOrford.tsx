...
import { HOTEL_IDS_MAGOG_ORFORD } from '@/data/hotels/byArticle/magog-orford';
...
const hotels = pickHotels(HOTEL_IDS_MAGOG_ORFORD);
...
export default function BlogArticleMagogOrford() {
  return (
    <DestinationArticleTemplate slug="magog-orford" title="Magog-Orford - Entre Lacs et Montagnes">
      <article id="blog_article_magog_orford" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          <p>
            La région de Magog-Orford, nichée entre le majestueux lac Memphrémagog et le parc
            national du Mont-Orford, offre un cadre enchanteur pour des vacances actives en toute
            saison. Cette destination prisée des Cantons-de-l'Est combine harmonieusement activités
            nautiques, randonnées en montagne et expériences gastronomiques.
          </p>
          <div className="my-8">
            <Image
        ...
        <section className="rounded-lg bg-gray-50 p-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a
              href={bookingAwin('https://www.booking.com/city/ca/magog.html')}
