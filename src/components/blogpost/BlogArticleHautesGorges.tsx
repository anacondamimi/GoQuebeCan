...
const hotels = [
  {
    name: 'Auberge des Hautes-Gorges',
    category: 'Vue sur Rivière',
    description: 'Vue imprenable sur la rivière Malbaie',
    price: 'À partir de 189$/nuit',
    link: 'https://www.booking.com/hotel/ca/auberge-des-hautes-gorges.html',
  ...
  },
  {
    ...
    category: 'Luxe',
    description: 'Hôtel historique à 30 minutes du parc',
    price: 'À partir de 299$/nuit',
    link: 'https://www.booking.com/hotel/ca/fairmont-le-manoir-richelieu.html',
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80',
  },
  {
    name: 'Auberge La Marmite',
    category: 'Charme',
    description: 'Auberge familiale à proximité',
    price: 'À partir de 149$/nuit',
    link: 'https://www.booking.com/hotel/ca/auberge-la-marmite.html',
