...
export default function BlogArticleBaieSaintPaul() {
  ...
  const hotels = [
    {
      ...
      link: bookingAwin('https://www.booking.com/hotel/ca/la-ferme.html'),
    ...
    },
    {
      ...
      link: bookingAwin('https://www.booking.com/hotel/ca/auberge-la-grande-maison.html'),
    ...
    },
    {
      ...
      link: bookingAwin('https://www.booking.com/hotel/ca/la-pignoronde.html'), // à valider si différent
  ...
  return (
    <DestinationArticleTemplate
      slug="baie-saint-paul"
      title="Baie-Saint-Paul - Le Cœur Artistique de Charlevoix"
    >
      <article id="blog_article_baie_saint_paul" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          ...
          <div className="my-8">
            <Image
              src="/images/destinations/baie-saint-paul.avif"
              alt="Baie-Saint-Paul"
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div className="rounded-lg bg-white p-6 shadow-md">
              <H3 className="mb-3 text-xl font-semibold">Village d'Artistes</H3>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              <H3 className="mb-3 text-xl font-semibold">Nature Grandiose</H3>
              <p className="text-gray-600">
        ...
        <section className="rounded-lg bg-gray-50 p-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            <a
              href={bookingAwin('https://www.booking.com/city/ca/baie-saint-paul.html')}
              className="rounded-lg bg-indigo-600 px-6 py-3 text-white transition-colors hover:bg-indigo-700"
            >
              Réserver un Hébergement
            </a>
            <a
              href="https://www.getyourguide.com/fr-fr/s/?q=Tourisme%2C+Baie-Saint-Paul&searchSource=3&src=search_bar"
