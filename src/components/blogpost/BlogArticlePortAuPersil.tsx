...
import { HOTEL_IDS_PORT_AU_PERSIL } from '@/data/hotels/byArticle/port-au-persil';
...
const hotels = pickHotels(HOTEL_IDS_PORT_AU_PERSIL);
...
export default function BlogArticlePortAuPersil() {
  return (
    <DestinationArticleTemplate
      slug="port-au-persil"
      title="Port-au-Persil - Joyau Caché de Charlevoix"
    >
      <article id="blog_article_port_au_persil" className="mx-auto max-w-4xl bg-white px-4 py-12">
        ...
        <section className="prose mb-12 lg:prose-xl">
          <p>
            Port-au-Persil, niché dans les falaises de Charlevoix, est un secret bien gardé qui
            offre l'un des plus beaux paysages côtiers du Québec. Ce hameau historique, avec ses
            maisons ancestrales et son petit port naturel, semble figé dans le temps.
          </p>
          <div className="my-8">
            <Image
        ...
        <section className="rounded-lg bg-gray-50 p-8 text-center">
          <H2 className="mb-4 text-2xl font-bold text-gray-900">
            Prêt à Découvrir Port-au-Persil ?
          </H2>
          ...
          <div className="flex justify-center gap-4">
            <a
              href={bookingAwin('https://www.booking.com/region/ca/port-au-persil.html')}
