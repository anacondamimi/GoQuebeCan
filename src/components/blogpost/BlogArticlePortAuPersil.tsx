...
const hotels = [
  {
    name: 'Auberge des Falaises',
    category: 'Vue sur Mer',
    description: 'Vue spectaculaire sur le Saint-Laurent',
    price: 'À partir de 169$/nuit',
    link: 'https://www.booking.com/hotel/ca/auberge-des-falaises.html',
    image: 'https://images.unsplash.com/photo-1513977055326-8ae6272d90a7?auto=format&fit=crop&q=80',
  },
  {
    name: 'Gîte du Hameau',
    category: 'B&B',
    description: 'Maison ancestrale avec petit-déjeuner local',
    price: 'À partir de 129$/nuit',
    link: 'https://www.booking.com/hotel/ca/gite-du-hameau.html',
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&q=80',
  },
  {
    name: 'Chalets Port-au-Persil',
    category: 'Chalet',
    description: 'Chalets rustiques avec vue sur mer',
    price: 'À partir de 149$/nuit',
    link: 'https://www.booking.com/hotel/ca/chalets-port-au-persil.html',
