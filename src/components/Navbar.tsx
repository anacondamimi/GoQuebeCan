...
import {
  Tent, Video, ShoppingBag, Menu, X, Compass,
  Plane, Route, Laptop, Users, Mail,
} from 'lucide-react';
...
const navLinks = [
  ...
  { href: '/objets', label: 'Objets', icon: ShoppingBag },
...
export default function Navbar() {
  ...
  return (
  <nav className={`fixed top-0 left-0 right-0 z-[999] transition-all duration-300 ${scrolled ? 'bg-white/80 backdrop-blur-md shadow-md' : 'bg-white shadow-sm'}`}>
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between h-16 w-full px-4 overflow-hidden">
        {/* Logo seulement */}
        <Link href="/" aria-label="Accueil" className="ml-0 flex-shrink-0">
          <Image
            src="/logo.avif"
            alt="Logo GoQuébeCan"
            width={48}
        ...
        {/* Navigation desktop */}
        <div className="hidden md:flex items-center gap-x-3 pr-4">
