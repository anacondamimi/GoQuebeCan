...
export default function AddCommunityPDF() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 p-4 border rounded-lg bg-white shadow">
      ...
      <input name="titre" placeholder="Titre" value={form.titre} onChange={handleChange} className="w-full p-2 border rounded" required />
      <input name="lien_pdf" placeholder="Lien vers le PDF" value={form.lien_pdf} onChange={handleChange} className="w-full p-2 border rounded" required />
      <input name="image_url" placeholder="Image (URL)" value={form.image_url} onChange={handleChange} className="w-full p-2 border rounded" />
      <input name="auteur" placeholder="Auteur" value={form.auteur} onChange={handleChange} className="w-full p-2 border rounded" />
