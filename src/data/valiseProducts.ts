...
export const PRODUCTS: ValiseProduct[] = [
...

  {
    ...
    priority: 'essentiel',
    category: 'soleil',
    url: 'https://link.amazon/B0eSJsD5e',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'essentiel',
    category: 'soleil',
    url: 'https://link.amazon/B0bCsn0gf',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'essentiel',
    category: 'soleil',
    url: 'https://link.amazon/B02o254uV',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'utile',
    category: 'soleil',
    url: 'https://link.amazon/B06e7yQaZ',
    cta: 'Voir sur Amazon',
    active: true,
  },
  ...
  // ─────────── CÉNOTES & SNORKELING ───────────
  {
    ...
    priority: 'utile',
    category: 'eau',
    url: 'https://link.amazon/B0dj3AzBf',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'optionnel',
    category: 'eau',
    url: 'https://link.amazon/B034GPMdE',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'utile',
    category: 'eau',
    url: 'https://link.amazon/B02pDoTgY',
    cta: 'Voir sur Amazon',
    active: true,
  },
  ...
  // ─────────── SANTÉ & PHARMACIE ───────────
  {
    ...
    priority: 'essentiel',
    category: 'sante',
    url: 'https://link.amazon/B011YiVmr',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'essentiel',
    category: 'sante',
    url: 'https://link.amazon/B07g9BrTT',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'optionnel',
    category: 'sante',
    url: 'https://link.amazon/B02Dh3qPE',
    cta: 'Voir sur Amazon',
    active: true,
  },
  ...
  // ─────────── TECHNO & CONNEXION ───────────
  {
    ...
    priority: 'essentiel',
    category: 'tech',
    url: 'https://airalo.pxf.io/c/7555643/1268485/15608',
  ...
  },
  {
    ...
    priority: 'utile',
    category: 'tech',
    url: 'https://link.amazon/B0dGNvLGV',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    emoji: '🔌',
    image: '',
    desc: 'Le Mexique utilise des prises de type A/B comme au Canada — souvent pas besoin d’adaptateur, à vérifier selon son pays de départ.',
    priority: 'optionnel',
    category: 'tech',
    url: 'https://link.amazon/B0dxFsfv1',
    cta: 'Voir sur Amazon',
    active: true,
  },
  ...
  // ─────────── PRATIQUE & BAGAGE ───────────
  {
    ...
    priority: 'utile',
    category: 'pratique',
    url: 'https://link.amazon/B05D8ylPA',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'utile',
    category: 'pratique',
    url: 'https://link.amazon/B0iCY5ClF',
    cta: 'Voir sur Amazon',
    active: true,
  },
  {
    ...
    priority: 'optionnel',
    category: 'pratique',
    url: 'https://link.amazon/B0ifnI5dl',
    cta: 'Voir sur Amazon',
    active: true,
  },
  // ─────────── AVANT DE PARTIR ───────────
